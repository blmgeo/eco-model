var container=document.querySelector(".container");title=document.querySelector(".title");description=document.querySelector(".description");citation=document.querySelector(".citation");iframe=document.querySelector("iframe");links=document.querySelectorAll(".nav-link");list=document.querySelector(".nav-list");menu=document.querySelector(".menu-toggle");
