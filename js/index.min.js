...
citation.innerHTML="\n        <a target='_blank' class='ref' href='http://mathworld.wolfram.com/Lotka-VolterraEquations.html'>\n        - Wolfram Mathworld\n        </a> (Lotka-Volterra Equations)\n        ",explanation.innerHTML="\n\n        ",a="Rorrab"}iframe.setAttribute("src","https://codepen.io/blmgeo/embed/preview/"+a+"?height=394&theme-id=light&slug-hash="+a+"&default-tab=result&user=blmgeo&embed-version=2")},getContent=function(){container.classList.remove("entering");container.classList.add("leaving");
setTimeout(function(){loadPen()},400);setTimeout(function(){container.classList.remove("leaving");container.classList.add("entering")},500)};window.addEventListener("load",loadPen);window.addEventListener("popstate",getContent);menu.addEventListener("click",function(){list.classList.toggle("open")});list.addEventListener("click",function(){list.classList.toggle("open")});
