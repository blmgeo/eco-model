var container=document.querySelector(".container");title=document.querySelector(".title");quote=document.querySelector(".quote");citation=document.querySelector(".citation");explanation=document.querySelector(".explanation");iframe=document.querySelector("iframe");links=document.querySelectorAll(".nav-link");list=document.querySelector(".nav-list");menu=document.querySelector(".menu-toggle");
var updateNav=function(a){links.forEach(function(a){a.classList.contains("active")&&a.classList.remove("active")});a.classList.add("active")},loadPage=function(){var a="",b=window.location.href.split("#")[1]||"About";iframe.style.display="block";quote.style.display="block";citation.style.display="block";switch(b){case "About":updateNav(links[0]);quote.style.display="none";iframe.style.display="none";citation.style.display="none";title.innerHTML="About This Project";explanation.innerHTML="\n    This website is intended to demonstrate the functionality of the EcoModel.js library*, which is documented <a class='nav-link' href='https://www.github.com/blmgeo/eco-model' target='_blank'>on GitHub</a>. Animations and brief descriptions are provided to highlight the library's functionality, especially for those who are not familiar with ecological modeling and analysis. If viewing this project on a mobile device, animations are best viewed in landscape orientation.\n    <br><br>\n    * Please note that the library is currently under major development.\n    ";
break;case "SteadyState":updateNav(links[1]);title.innerHTML="Steady State";quote.innerHTML='\n    When the flow of a substance into a lake, the atmosphere, an animal, or any other "box" is equal\n    to the outflow of that substance, then the amount, or "stock", of that substance in the box will\n    be constant. This is called a "steady state" or "equilibrium". The ratio of the <em>stock</em> in the box\n    to the <em>flow rate</em> (in or out) is called the <em>residence time</em>.\n    ';citation.innerHTML=
...
a="Rorrab"}iframe.setAttribute("src","https://codepen.io/blmgeo/embed/preview/"+a+"?height=394&theme-id=light&slug-hash="+a+"&default-tab=result&user=blmgeo&embed-version=2")},getContent=function(){container.classList.remove("entering");container.classList.add("leaving");setTimeout(function(){loadPage()},400);setTimeout(function(){container.classList.remove("leaving");container.classList.add("entering")},500)};window.addEventListener("load",loadPage);window.addEventListener("popstate",getContent);
menu.addEventListener("click",function(){list.classList.toggle("open")});list.addEventListener("click",function(){list.classList.toggle("open")});
